...
class CustomerFoodListAdapter(private val lists: List<CustomerFoodListDTOItem>) : RecyclerView.Adapter<CustomerFoodListAdapter.ListViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomerFoodListAdapter.ListViewHolder {
        ...
        return CustomerFoodListAdapter.ListViewHolder(binding)
    }
